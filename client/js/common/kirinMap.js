...
const mapContainer = document.getElementById('map'),
	mapOption = {
		center: new kakao.maps.LatLng(37.587047, 126.919549),
		level: 1,
	};
...
const imageSrc = '../../assets/images/mappin.png',
	...
	imageOption = { offset: new kakao.maps.Point(15, 65) };

const markerImage = new kakao.maps.MarkerImage(imageSrc, imageSize, imageOption),
	markerPosition = new kakao.maps.LatLng(37.587047, 126.919549);
