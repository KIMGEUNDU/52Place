...
const mapContainer = document.getElementById('map'),
	mapOption = {
		center: new kakao.maps.LatLng(37.559101, 126.922452),
		level: 1,
	};
...
const imageSrc = '../../assets/images/mappin.png',
	...
	imageOption = { offset: new kakao.maps.Point(-5, 50) };

const markerImage = new kakao.maps.MarkerImage(imageSrc, imageSize, imageOption),
	markerPosition = new kakao.maps.LatLng(37.559101, 126.922452);
