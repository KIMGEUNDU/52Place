...
const mapContainer = document.getElementById('map'),
	mapOption = {
		center: new kakao.maps.LatLng(37.549541, 126.917323),
		level: 1,
	};
...
const imageSrc = '../../assets/images/mappin.png',
	...
	imageOption = { offset: new kakao.maps.Point(25, 70) };

const markerImage = new kakao.maps.MarkerImage(imageSrc, imageSize, imageOption),
	markerPosition = new kakao.maps.LatLng(37.549541, 126.917323);
