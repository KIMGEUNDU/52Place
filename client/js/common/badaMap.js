...
const mapContainer = document.getElementById('map'),
	mapOption = {
		center: new kakao.maps.LatLng(37.560376, 126.921038),
		level: 1,
	};
...
const imageSrc = '../../assets/images/mappin.png',
	...
	imageOption = { offset: new kakao.maps.Point(10, 70) };

const markerImage = new kakao.maps.MarkerImage(imageSrc, imageSize, imageOption),
	markerPosition = new kakao.maps.LatLng(37.560376, 126.921038);
