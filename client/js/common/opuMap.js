...
const mapContainer = document.getElementById('map'),
	mapOption = {
		center: new kakao.maps.LatLng(35.078725, 129.045259),
		level: 1,
	};
...
const imageSrc = '../../assets/images/mappin.png',
	...
	imageOption = { offset: new kakao.maps.Point(40, 50) };

const markerImage = new kakao.maps.MarkerImage(imageSrc, imageSize, imageOption),
	markerPosition = new kakao.maps.LatLng(35.078725, 129.045259);
